...
public abstract class NetworkLatency {
     ...
     * "A single model isapplicable to all considered lengths of packets."
     * It's for an ADSLv2+ system, so they don't take into account the distance.
     * <p>
     * Here are the results by quantile, not that great in our case.
     * TODO: This does not seem to match our case. GPD could be good as a model, but
     * we need other data to have the right model
     * <p>
     * 0 -0.3
     * 1 -0.29645751870684156
     * 2 -0.2928281063750007
     * 3 -0.2891087096885191
     * 4 -0.28529613509832147
     * 5 -0.28138704083443744
     * [...]
     * 38 -0.06180689273798645
     * 39 -0.05056584458776098
     * 40 -0.03887366470983794
     * 41 -0.026704268331683878
     * 42 -0.014029585091834773
     * 43 -8.193702810404546E-4
     * 44 0.012959005564730341
     * 45 0.027340791642455564
     * 46 0.04236411981076765
     * 47 0.058070299386147994
     * [...]
     * 81 2.0067305885282534
     * 82 2.2077729124238217
     * 83 2.43752479733014
     * 84 2.7021609664135657
     * 85 3.009690552818672
     * 86 3.370674235256015
     * 87 3.7992995050751803
     * 88 4.315038306782648
     * 89 4.94528535995752
     * 90 5.729716078773951
     * 91 6.7278063481168795
     * 92 8.032504244579048
     * 93 9.796721337967568
     * 94 12.288913064025722
     * 95 16.02227008669991
     * 96 22.09936448992795
     * 97 33.332094707414804
     * 98 59.22203123687722
    ...
    public static class EthScanNetworkLatency extends NetworkLatency {
         ...
         * </p>
         * These figures are for blocks, so they represent a worse case. As well,
         * some of the nodes may be dead.
         */

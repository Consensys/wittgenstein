...
public class GSFSignature implements Protocol {
  ...
  public static class GSFSignatureParameters extends WParameters {
    ...
    public GSFSignatureParameters(int nodeCount, double ratioThreshold, int pairingTime,
  ...
  private static GSFSignature newProtocol() {
    ...
    String nb = RegistryNodeBuilders.ALL_CITIES;//RegistryNodeBuilders.name(true, false, 0.33);
    String nl = NetworkLatency.NetworkLatencyByCity.class.getSimpleName();//AwsRegionNetworkLatency.class.getSimpleName();
